...
5. To start the game yourself, set `auto_launch_game` to `false` in `config.json`, then run `Start-Mod.cmd` and launch Onimusha: Way of the Sword manually from Steam.
